    ...
    <div class="webshop__content">
        <div class="shopping-cart">
            ...
            <?php if ($shoppingCart->hasProducts()): ?>
                ...
                <?php endforeach; ?>
                <strong>Totaalbedrag: <?php echo $shoppingCart->getTotalPrice();?></strong><br>
                <a href="cart.php?action=removeAll&item_index=<?php echo $index?>" class="remove_all">verwijder alles</a>
